...
using NasuTek.DevEnvironment.Workspace.TextEditor.Document;
using NasuTek.DevEnvironment.Workspace.TextEditor.Util;

namespace NasuTek.DevEnvironment.Workspace.TextEditor
{
...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		{
			new NasuTek.DevEnvironment.Workspace.TextEditor.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new NasuTek.DevEnvironment.Workspace.TextEditor.Actions.SelectWholeDocument().Execute(textArea);
		}
