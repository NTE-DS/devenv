...
namespace NasuTek.DevEnvironment.Workspace.TextEditor.Undo
{
	/// <summary>
	...
	internal sealed class UndoQueue : IUndoableOperation
	{
		...
		public UndoQueue(Stack<IUndoableOperation> stack, int numops)
		{
			...
			Debug.Assert(numops > 0 , "NasuTek.DevEnvironment.Workspace.TextEditor.Undo.UndoQueue : numops should be > 0");
